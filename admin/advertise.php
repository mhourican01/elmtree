...
<html>
	...
	<div class="column is-one-third">
		<p class="title">Advertise your item</p>
		<form action='process/adprocess.php' method='POST' enctype='multipart/form-data'> 
			<p>Title (required)</p>
			<div class="field">
			  <div class="control">
				<input class="input" type="text" name ="shoename" placeholder="Title your advertisement" required>
			  </div>
			</div>
			...
			<div class="field">
			  <div class="control">
				<input class="input" type="text" name ="shoeprice" placeholder="Price your item" required>
			  </div>
			</div>
			
			<p>Gender</p>
			<div class='select'>
				<select name='shoegender'>
				<?php
			...
			<div class="field">
			  <div class="control">
				<input class="input" type="text" name="shoeblurb" placeholder="Describe your item, e.g. its condition, materials, etc.">
			  </div>
			</div>


			<label class="checkbox">
				<input type="checkbox" name="hideitem" value="1">
					...
					<div class="control">
						<div class="file has-name">
							<label class="file-label">
								<input class="file-input" type="file" name="itemimg[]" multiple id="file" required>
